...
export const GEOGRAPHY_QUESTIONS: (GeographyQuestion & { gradeLevel: number })[] = [
  ...
  { gradeLevel: 1, type: 'nature', question: 'What do we call water with land all around it?', answer: 'Lake', options: ['Lake', 'Mountain', 'Road', 'Cloud'], funFact: 'A lake is water surrounded by land.' },
  { gradeLevel: 1, type: 'map', question: 'What place do kids go to learn with teachers?', answer: 'School', options: ['School', 'Ocean', 'Volcano', 'Desert'], funFact: 'Maps can show familiar places like home, school, and parks.' },
  { gradeLevel: 2, type: 'map', question: 'Which map symbol might show a hospital?', answer: 'A cross or H', options: ['A cross or H', 'A banana', 'A shoe', 'A moon'], funFact: 'Map symbols help people find important places quickly.' },
  { gradeLevel: 2, type: 'nature', question: 'What do we call land beside the ocean?', answer: 'Coast', options: ['Coast', 'Peak', 'Cave', 'Cloud'], funFact: 'A coast is where land meets the sea or ocean.' },
  { gradeLevel: 3, type: 'map', question: 'If north is up on a map, which way is south?', answer: 'Down', options: ['Down', 'Right', 'Left', 'Inside'], funFact: 'Many classroom maps show north at the top and south at the bottom.' },
  { gradeLevel: 3, type: 'country', question: 'Which country has the city Paris?', answer: 'France', options: ['France', 'Brazil', 'Japan', 'Canada'], funFact: 'Paris is the capital of France.' },
          ...
          <div className="grid grid-cols-1 gap-3 mb-6 sm:grid-cols-2">
            {question.options.map((option, index) => {
              ...
              return (
                ...
                >
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/85 text-base font-black text-blue-700 shadow-sm">
