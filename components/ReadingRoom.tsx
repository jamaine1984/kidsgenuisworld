...
export const READING_PASSAGES: ReadingPassage[] = [
  ...
  { id: 'g1-lunch-count', level: 3, title: 'Lunch Count', passage: 'Ms. Nova counted eight apples for snack. Four students chose apples first. She checked the basket to see how many apples were left.', question: 'What is Ms. Nova checking?', answer: 'How many apples are left', options: ['How many apples are left', 'Where the bus parked', 'Why the lights are off', 'Which book is longest'], skill: 'Understand problem goal' },
